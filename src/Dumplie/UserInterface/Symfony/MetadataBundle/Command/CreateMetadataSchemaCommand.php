...
final class CreateMetadataSchemaCommand extends Command implements ContainerAwareInterface
{
    /**
    ...
    {
        $this
            ->setName('dumplie:metadata:schema:create')
            ->setDescription('Creates metadata schema in storage.')
            ->setDefinition([]);
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(sprintf('Storage schema create successfully! "<info>%s</info>" %s made', count($changeSet->operations()), $pluralization));
